...
<div class="container ">
    ...
    <div class="fundoBackground profileBTxt blockWiki3">
        <h4 style="color:yellow;" class="midH4">Quais foram as <br>inspirações do jogo?</h4>
        <p class="borderText textPosition">O mais novo jogo produzido pela SteelFreak, Agonizing Village 3, foi totalmente baseado em seus jogos passados, Agonizing Village 1 e 2, que também tiveram muita inspiração no mundo de The Witcher. o jogo se passa em uma ambientação medieval, dando mais imersão e agitando a mente e criatividade do jogador.</p>
    </div>
</div>
<div class="container">
