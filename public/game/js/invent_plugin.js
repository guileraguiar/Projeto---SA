var InventModalPlugin = function (scene) {
  this.scene = scene;
...
InventModalPlugin.register = function (PluginManager) {
  PluginManager.register('InventModalPlugin', InventModalPlugin, 'dialogModal');
};

InventModalPlugin.prototype = {
  ...
  init: function (opts) {
    ...
    this.windowHeight = opts.windowHeight || 370;
    this.windowWidth = opts.windowWidth || 270;
    this.padding = opts.padding || 5;
    this.closeBtnColor = opts.closeBtnColor || 'darkgoldenrod';
    this.dialogSpeed = opts.dialogSpeed || 50;
  ...
  _setText: function (text) {
    ...
    this.text = this.scene.make.text({
      ...
      text,
      style: {
        wordWrap: { width: this.windowWidth - (this.padding)-10}
      }
    });
  },
  ...
  _createCloseModalButtonBorder: function () {
    var x = this._getGameWidth() - this.windowWidth - this.padding -239;
    var y = this._getGameHeight() - this.windowHeight - this.padding + 1;
  ...
  _createCloseModalButton: function () {
    ...
    this.closeBtn = this.scene.make.text({
      x: this._getGameWidth() - this.windowWidth - this.padding -233,
