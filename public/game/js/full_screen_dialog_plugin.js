var FullScreenDialogModalPlugin = function (scene) {
  this.scene = scene;
...
FullScreenDialogModalPlugin.register = function (PluginManager) {
  PluginManager.register('FullScreenDialogModalPlugin', FullScreenDialogModalPlugin, 'dialogModal');
};

FullScreenDialogModalPlugin.prototype = {
  ...
  init: function (opts) {
    ...
    this.windowHeight = opts.windowHeight || 375;
